...
(iii) Insert a [bcgov lifecycle badge](https://github.com/bcgov/repomountie/blob/8b2ebdc9756819625a56f7a426c29f99b777ab1d/doc/state-badges.md) into an .Rmd or .md file to indicate the current state of the project (uses `insert_bcgov_lifecycle_badge()`).
...
<details><summary><strong>Insert a bcgov lifecycle badge into my README file</strong></summary>
