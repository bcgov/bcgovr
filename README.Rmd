...
To add you project to bcgov GitHub with `use_bcgov_github` users need to have a GitHub account _and_ be a [member of the bcgov GitHub organization](https://github.com/bcgov/BC-Policy-Framework-For-GitHub/blob/master/BC-Gov-Org-HowTo/Cheatsheet.md). 
