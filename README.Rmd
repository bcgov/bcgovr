...
<details><summary>Open a new bcgov R project using git & GitHub</summary>
</details>

<details><summary>Open a new bcgov R project using git (_without_ GitHub)</summary>
</details>

<details><summary>Create a new&mdash;or populate an existing&mdash;bcgov R project or package with an out-of-the-box folder & file structure </summary>
</details>

<details><summary>Add all or some of the required GitHub files to my bcgov R project or package</summary>

Add the [bcgov GitHub required](https://github.com/bcgov/BC-Policy-Framework-For-GitHub/blob/master/BC-Gov-Org-HowTo/Cheatsheet.md) files&mdash;a LICENSE, a README, a CODE OF CONDUCT and a CONTRIBUTING file&mdash;to any new or existing bcgov R project or package using `use_bcgov_req()`. 

You can use the `licence`, `coc_email` & `rmarkdown` arguments to change the default Apache 2.0 licence, add your contact details to the Code of Conduct, or decline a README.Rmd file&mdash;maybe you only want a README.md?
