...
1. At [github.com/bcgov](github.com/bcgov), click on the green **New** button to create a new repository. For this example, we will use the repository name *my_new_repo*. Your actual repository names will be informative and specific to your project. 
