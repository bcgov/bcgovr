...
You can set it up by running `use_bcgov_pkgdown()`. This creates a `_pkgdown.yml` file for you which ensures your site will be built using the bcgov template.
